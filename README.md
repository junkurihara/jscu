...
> **CURRENT STATUS**: Now we are struggling to rewrite JavaScript codes of every subpackage in `jscu` to TypeScript for maintainability. We have done it for the following packages at this point (Nov. 1, 2019).
> - `js-crypto-env`
> - `js-crypto-random`
> - `js-crypto-hash`
> - `js-crypto-aes`
